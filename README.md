...
- 📄 Portfolio: **[muhammadbinriaz.netlify.app](https://muhammadbinriaz.netlify.app/)**
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,fastapi,js,ts,html,css,react,nextjs,nodejs,express,django,flask,tailwind,postgres,mysql,mongodb,redis,docker,linux,nginx,git,github,aws,gcp,azure,vscode,postman,bash&perline=10" alt="Languages and tools"/>
</p>
